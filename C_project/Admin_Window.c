...
void make_trans(void){
	...
	printf("%d",tot_clients[num].Balance);
	printf("enter the account ID you want to transfer to:\n");
		...
		if(transfer_amount<tot_clients[num].Balance){
		
		tot_clients[num].Balance=tot_clients[num].Balance-transfer_amount;
...
void change_stat(void){
	...
	scanf("%s",&Change_status);
	strcpy(tot_clients[num].Account_status,Change_status);
}
void withdraw(void){
	...
	printf("Enter the ammount of money you want to withdraw\n"); 
		scanf("%d\n",&withdrawn_amount);
		if(withdrawn_amount<tot_clients[num].Balance){
		
		tot_clients[num].Balance=tot_clients[num].Balance-withdrawn_amount;
		printf("%d\n",tot_clients[num].Balance);
		}
		else 
		{
